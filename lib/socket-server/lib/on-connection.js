	...
	function onEditAttribute(socket, data) {
		...
		buildDomFromFile(data.fname, function (err, markedDom) {
			...
			var element = markedDomUtils.findOne(function (e) {
				...
				var elementAttributes = e.attribs;


				// file verification
				var isCorrectFile = elementAttributes[FNAME_ATTRIBUTE] === data.fname;

				// xpath verification
				var isCorrectNode = elementAttributes[X_PATH_ATTRIBUTE] === data.xPath;
			...
			// write the file
			writeDomToFile(data.fname, markedDom);
		})
	}
